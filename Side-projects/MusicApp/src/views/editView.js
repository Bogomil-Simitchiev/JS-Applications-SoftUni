...
import { editAlbum, getAlbum } from '../services/requests.js';
...
function editHandler(e) {
    ...
    if (name !== '' && imgUrl !== '' && price !== ''
        ...
        && genre !== ''
        && description !== '') {
        editAlbum({ name, imgUrl, price, releaseDate, artist, genre, description },id);
    }

}

const editTemplate = (album) =>
html`
<section class="editPage">
    <form @submit=${editHandler}>
        <fieldset>
            ...
            <div class="container" id="${album._id}">
